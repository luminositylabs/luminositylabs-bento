...
These notes were last updated to reflect building on macOS Sequoia v15.5, packer v1.13.0, parallels v20.3.1, and
 virtualbox v7.1.8 (2025-06-03).

### Current known issues

- [2025-06-03] MacOS v15.5 / Parallels v20.x
...
- [2025-06-03] MacOS v15.5 / virtualbox v7.1.8 / AlmaLinux & RockyLinux
...
- [2025-06-03] MacOS v15.5 / virtualbox v7.1.8 / Ubuntu
...
```
vagrant cloud version create -d "box v20250603.01, packer v1.13.0, parallels v20.3.1, virtualbox v7.1.8" luminositylabsllc/bento-almalinux-9 20250603.01
```

3. Create a provider for the version of the box:
```
vagrant cloud provider create luminositylabsllc/bento-almalinux-9 parallels  20250603.01
vagrant cloud provider create luminositylabsllc/bento-almalinux-9 virtualbox 20250603.01
```

4. Upload the box file for the provider:
```
vagrant cloud provider upload luminositylabsllc/bento-almalinux-9 parallels  20250603.01 amd64 <file>
vagrant cloud provider upload luminositylabsllc/bento-almalinux-9 virtualbox 20250603.01 amd64 <file>
``` 

5. Release a version:
```
vagrant cloud version release luminositylabsllc/bento-almalinux-9 20250603.01
```
...
vagrant cloud publish --architecture amd64 \
                      ...
                      --version-description "box v20250603.01, packer v1.13.0, parallels v20.3.1, virtualbox v7.1.8" \
                      --no-private --no-release \
                      --short-description "AlmaLinux 9 prepared with packer templates from Chef Bento project" \
                      luminositylabsllc/bento-almalinux-9 20250603.01 parallels builds/almalinux-9.5-x86_64.parallels.box
...
vagrant cloud publish --architecture amd64 \ 
                      ...
                      --no-private --no-release  \
                      --short-description "AlmaLinux 9 prepared with packer templates from Chef Bento project" \
                      luminositylabsllc/bento-almalinux-9 20250603.01 virtualbox builds/almalinux-9.5-x86_64.virtualbox.box
```
...
for P in parallels virtualbox; do
    time vagrant cloud publish \
        ...
        --short-description "AlmaLinux 8 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-almalinux-8 20250603.01 ${P} builds/almalinux-8.10-x86_64.${P}.box   
done
vagrant cloud version release luminositylabsllc/bento-almalinux-8 20250603.01
```
...
for P in parallels virtualbox; do
    time vagrant cloud publish \
        ...
        --no-private --no-release \
        --short-description "AlmaLinux 9 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-almalinux-9 20250603.01 ${P} builds/almalinux-9.5-x86_64.${P}.box   
done
vagrant cloud version release luminositylabsllc/bento-almalinux-9 20250603.01
```
...
for P in parallels; do
    time vagrant cloud publish \
        ...
        --no-private --no-release \
        --short-description "AlmaLinux 9 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-almalinux-9-aarch64 20250603.01 ${P} builds/almalinux-9.5-aarch64.${P}.box
done
vagrant cloud version release luminositylabsllc/bento-almalinux-9-aarch64 20250603.01
```
...
for P in parallels virtualbox; do
    time vagrant cloud publish \
        ...
        --short-description "RockyLinux 8 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-rockylinux-8 20250603.01 ${P} builds/rockylinux-8.10-x86_64.${P}.box   
done
vagrant cloud version release luminositylabsllc/bento-rockylinux-8 20250603.01
```
...
for P in parallels virtualbox; do
    time vagrant cloud publish \
        ...
        --short-description "RockyLinux 9 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-rockylinux-9 20250603.01 ${P} builds/rockylinux-9.5-x86_64.${P}.box   
done
vagrant cloud version release luminositylabsllc/bento-rockylinux-9 20250603.01
```
...
for P in parallels; do
    time vagrant cloud publish \
        ...
        --no-private --no-release \
        --short-description "RockyLinux 9 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-rockylinux-9-aarch64 20250603.01 ${P} builds/rockylinux-9.5-aarch64.${P}.box
done
vagrant cloud version release luminositylabsllc/bento-rockylinux-9-aarch64 20250603.01
```
...
for P in parallels virtualbox; do
    time vagrant cloud publish \
        ...
        --short-description "Ubuntu 22.04 amd64 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-ubuntu-22.04 20250603.01 ${P} builds/ubuntu-22.04-x86_64.${P}.box   
done
vagrant cloud version release luminositylabsllc/bento-ubuntu-22.04 20250603.01
```
...
for P in parallels; do
    time vagrant cloud publish \
        ...
        --short-description "Ubuntu 22.04 arm64 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-ubuntu-22.04-arm64 20250603.01 ${P} builds/ubuntu-22.04-aarch64.${P}.box
done
vagrant cloud version release luminositylabsllc/bento-ubuntu-22.04-arm64 20250603.01
```
...
for P in parallels virtualbox; do
    time vagrant cloud publish \
        ...
        --short-description "Ubuntu 24.04 amd64 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-ubuntu-24.04 20250603.01 ${P} builds/ubuntu-24.04-x86_64.${P}.box   
done
vagrant cloud version release luminositylabsllc/bento-ubuntu-24.04 20250603.01
```
...
for P in parallels; do
    time vagrant cloud publish \
        ...
        --short-description "Ubuntu 24.04 arm64 prepared with packer templates from Chef Bento project" \
            luminositylabsllc/bento-ubuntu-24.04-arm64 20250603.01 ${P} builds/ubuntu-24.04-aarch64.${P}.box
done
vagrant cloud version release luminositylabsllc/bento-ubuntu-24.04-arm64 20250603.01
```
